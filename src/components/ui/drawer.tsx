...
const DrawerOverlay = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DrawerPrimitive.Overlay> & { excludeHeader?: boolean }
>(({ className, excludeHeader, ...props }, ref) => (
...
>(({ className, children, hideHandle, excludeHeader, fullHeight, ...props }, ref) => (
  <DrawerPortal>
    <DrawerOverlay excludeHeader={excludeHeader || fullHeight} />
